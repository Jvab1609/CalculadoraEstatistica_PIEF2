...
public class Calculadora extends javax.swing.JFrame {
    ...
    public void escreverHistorico(String operacoes) {
        try {
            ...
            String[] parametrosHide = {nomeSave, tipoHide, operacoes, preview, String.valueOf(colunasArquivo), String.valueOf(freq)};
    ...
    public void carregarHistorico() {
        try {
            ...
            // parametrosHide = {nomeSave, tipoHide, operacoes, preview, String.valueOf(colunasArquivo), String.valueOf(freq)};
            //System.out.println(parametros[3]);
            
            jTabbedPane1.setSelectedIndex(1);
            if (parametros[1].equals("arqv")) {
                arquivo = new File(parametros[3]);
